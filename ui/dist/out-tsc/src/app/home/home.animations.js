...
export const policyAnimation = trigger('policyAnimation', [
    transition(':enter', [
        style({ opacity: 0 }),
...
export const saveOptionAnimation = trigger('saveOptionAnimation', [
    transition(':enter', [
        style({ opacity: 0 }),
        animate('.2s ease')
    ])
]);
//# sourceMappingURL=home.animations.js.map